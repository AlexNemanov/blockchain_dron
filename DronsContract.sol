...
contract DronsContract {
  ...
  { 
    ...
    require(ordersIdsUsed[id]);
    require(dronAddress == ecrecover(keccak256(timestamp1), uint8(_v123 & 0xFF), _r1, _s1));
    require(dronAddress == ecrecover(keccak256(timestamp2), uint8((_v123 >> 8) & 0xFF), _r2, _s2));
    require(orders[id].recipientAddress == ecrecover(keccak256(timestamp3, status), uint8(_v123 >> 16), _r3, _s3));
